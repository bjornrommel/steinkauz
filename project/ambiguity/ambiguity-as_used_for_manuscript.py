...
class Graph():
    ...
    def __init__(self):
        ...
        # graphcs modus
        assert \
            GRAPHICS['modus'] in ['inline', 'qt'],\
            "Graphics.__init__: unknown graphics mode"
        # check ipython
        # note, my profiler cannot find run_line_magic, but continues without
        # graphics
        try:
    ...
    def paper(self):
        ...
        def _publiceps():
            ...
            if PUBLICEPS:
                ...
                plt.savefig(
                    PUBLICEPS, format='eps', bbox_inches='tight', pad_inches=0,
                    transparent=True)
